...
CSF::createOptions($prefix, array(
	'menu_title' => '主题设置',
	'menu_slug'  => 'cs-options',//菜单别名，在地址中使用的名字，如：http://www.***.com/wp-admin/admin.php?page=cs-options#tab=1
));

//
// Create a 基本设置,codestar-framework使用的font-awesome字体库,在classes/setup.class.php里面引入的
//
